...
silent only
cd ~/hackerrank/algorithm/warmup
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 time_conversion.cpp
argglobal
silent! argdel *
argadd time_conversion.cpp
edit time_conversion.cpp
